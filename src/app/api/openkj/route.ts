    ...
    for (const key of apiKeys) {
      ...
      if (isValid) {
        ...
        if (key.status === 'suspended') {
          ...
          return {
            error: true,
            errorString: 'The API key provided has been suspended. Visit https://billing.singrkaraoke.com/dashboard/billing for further information.'
          }
        }
        ...
        if (key.status === 'revoked') {
          ...
          return {
            error: true,
            errorString: 'The API key provided has been permanently revoked and is no longer authorized. A new key must be generated by visiting https://billing.singrkaraoke.com/dashboard/api-keys'
          }
        }
