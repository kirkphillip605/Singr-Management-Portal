...
export const metadata: Metadata = {
  ...
  description:
    'Professional karaoke management platform for Singr with real-time requests, multi-venue support, and OpenKJ integration.',
  keywords: [
    'karaoke',
    'singr',
    'openkj',
  ...
  twitter: {
    ...
    title: 'Singr Karaoke Connect',
    description:
      'Professional karaoke management platform with real-time requests and multi-venue support',
  },
  robots: {
    index: true,
    follow: true,
