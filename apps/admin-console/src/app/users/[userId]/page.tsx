...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@singr/ui'
import { Badge } from '@singr/ui'
import { AdminUserProfileForm } from '@/components/admin-user-profile-form'
import { AdminCreateVenueForm } from '@/components/admin-create-venue-form'
import { AdminVenueEditor } from '@/components/admin-venue-editor'
import { AdminApiKeyGenerator } from '@/components/admin-api-key-generator'
import { AdminApiKeyRevokeButton } from '@/components/admin-api-key-revoke-button'
import { Button } from '@singr/ui'
import Link from 'next/link'
import { formatDistanceToNow } from 'date-fns'
import { Alert, AlertDescription } from '@singr/ui'
...
export default async function AdminUserPage(props: PageProps<{ userId: string }>) {
  ...
  const adminLevel = session.user?.roles?.includes('super_admin') ? 'super_admin' : 'support'
